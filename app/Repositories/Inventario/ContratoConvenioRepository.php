...
class ContratoConvenioRepository
{
    use HasCache;
    ...
    {
        $this->flushCache();
        return ContratoConvenio::destroy($id);
    }
    ...
    {
        $contrato = ContratoConvenio::withCount('productos')->find($id);
        return $contrato && $contrato->productos_count > 0;
    }
