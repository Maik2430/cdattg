...
class TestWebSocketCommandTest extends TestCase
{
    ...
    {
        $exitCode = Artisan::call('websocket:test');
    ...
    {
        $exitCode = Artisan::call('websocket:test', ['type' => 'qr']);
    ...
    {
        $exitCode = Artisan::call('websocket:test', ['type' => 'asistencia']);
    ...
    {
        $exitCode = Artisan::call('websocket:test', ['type' => 'invalido']);
