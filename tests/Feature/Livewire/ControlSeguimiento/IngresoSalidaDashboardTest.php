...
namespace Tests\Feature\Livewire\ControlSeguimiento;

use App\Livewire\ControlSeguimiento\IngresoSalidaDashboard;
use App\Models\User;
...
class IngresoSalidaDashboardTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function puede_montar_el_componente(): void
    {
        Livewire::actingAs($this->user)
            ->test(IngresoSalidaDashboard::class)
            ->assertStatus(200);
    }
